import { ShoppingCart, UserPlus, LogIn, LogOut, Lock, Camera } from "lucide-react";
import { Link } from "react-router-dom";
import { useUserStore } from "../stores/useUserStore";
import { useCartStore } from "../stores/useCartStore";
import { useState } from "react";
import ImageSearchModal from "./ImageSearchModal"; // <-- ADD THIS
...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Image Search Modal */}
      {openSearchModal && (
        <ImageSearchModal close={() => setOpenSearchModal(false)} />
      )}
    </>
  );
};
